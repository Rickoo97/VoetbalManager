export const CONFIG = {
    ...
    // Moeilijkheidsgraden — Lastig is de aanbevolen default.
    // Normaal ≈ klassieke balans; Hardcore = krappe kas + streng bestuur.
    difficulties: {
        normal: {
            id: "normal",
            label: "Normaal",
            desc: "Klassieke balans — uitdagend, maar vergevingsgezind.",
            startBudget: 150000,
            prizeMult: 1.0,
            sponsorMult: 1.0,
            ticketMult: 1.0,
        ...
        hard: {
            id: "hard",
            label: "Lastig",
            desc: "Strakker budget, sterkere AI en een veeleisend bestuur. Aanbevolen.",
            startBudget: 100000,
            prizeMult: 0.75,
            sponsorMult: 0.8,
            ticketMult: 0.85,
        ...
        hardcore: {
            id: "hardcore",
            label: "Hardcore",
            desc: "Krappe kas, top-AI en een bestuur dat snel ontslaat.",
            startBudget: 70000,
            prizeMult: 0.55,
            sponsorMult: 0.65,
            ticketMult: 0.7,
